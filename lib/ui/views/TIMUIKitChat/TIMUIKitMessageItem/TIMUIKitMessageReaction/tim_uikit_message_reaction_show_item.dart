...
class TIMUIKitMessageReactionShowItem extends TIMUIKitStatelessWidget {
  ...
  final Function(int sticker, List<V2TimGroupMemberFullInfo?> memberList)
      onShowDetail;
  ...
  static Future<(String showName, V2TimGroupMemberFullInfo? memberInfo)>
      _getGroupMemberShowName(
    String groupID,
    String memberUserID,
  ) async {
    try {
  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    Set memberinfoSet = <V2TimGroupMemberFullInfo?>{};
              ...
              Container(
                ...
                child: ExtendedWrap(
                  ...
                  overflowWidget: GestureDetector(
                    onTap: () {
                      onShowDetail(sticker, List.from(memberinfoSet.toList()));
                    },
                    child: Text(
                              ...
                              ? FutureBuilder(
                                  ...
                                  builder: (BuildContext context,
                                    ...
                                    final hasData = snapshot.hasData &&
                                        snapshot.data?.$1.isNotEmpty == true;
                                    if (snapshot.hasData &&
                                        snapshot.data?.$2 != null) {
                                      memberinfoSet.add(snapshot.data?.$2);
                                    }
